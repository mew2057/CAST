...
STRUCT_DIRS=( "csm_types/struct_defs/common" \
              "csm_types/struct_defs/wm" \
...
ENUM_DIRS=( "csm_types/enum_defs/common" \
            "csm_types/enum_defs/wm" \
...
OUTPUT_FILE_TYPES=( "csmi_type_common.h" \
                    "csmi_type_wm.h" \
                    "csmi_type_bb.h" \
                    "csmi_type_inv.h" \
                    "csmi_type_diag.h" \
...
OUTPUT_FILE_FUNCTS=( "csmi_type_common_funct.h" \
                     "csmi_type_wm_funct.h" \
                     "csmi_type_bb_funct.h" \
                     "csmi_type_inv_funct.h" \
                     "csmi_type_diag_funct.h" \
                     "csmi_type_ras_funct.h" )

#OUTPUT_FILE_C=( "src/common/src/csmi_common_serial.c"\
...
OUTPUT_FILE_C=( "src/common/src/csmi_common_serial.c"\
                "src/wm/src/csmi_wm_serialization.c" \
...
OUTPUT_DEFS_TYPES=( "_CSMI_COMMON_TYPES_H_"\
                    "_CSMI_WM_TYPES_H_"\
                    "_CSMI_BB_TYPES_H_"\
                    "_CSMI_INV_TYPES_H_"\
                    "_CSMI_DIAG_TYPES_H_"\
...
OUTPUT_DEFS_FUNCTS=( "_CSMI_COMMON_TYPE_FUNCTS_H_" \
                     "_CSMI_WM_TYPE_FUNCTS_H_" \
...
OUTPUT_DEFS_INTERNAL=( "_CSMI_COMMON_INTERNAL_H_"\
                       "_CSMI_WM_INTERNAL_H_"\
...
O_FILE_C_INT=(  "src/common/src/csmi_common_internal.c"\
                "src/wm/src/csmi_wm_internal.c" \
...
# The internal C files.
O_FILE_C_PY=(   "src/common/src/csmi_python.cc"\
                "src/wm/src/csmi_wm_python.cc" \
...
O_FILE_H_INT=(  "src/common/include/csmi_common_internal.h"\
                "src/wm/include/csmi_wm_internal.h" \
...
O_FILE_H_TYPE_INT=( "src/common/include/csmi_common_type_internal.h"\
                    "src/wm/include/csmi_wm_type_internal.h" \
...
# The define guards for internal files.
OUTPUT_DEFS_TYPE_INTERNAL=( "_CSMI_COMMON_TYPE_INTERNAL_H_"\
                            "_CSMI_WM_TYPE_INTERNAL_H_"\
...
PYTHON_API_MODULES=( "csmi_common" \
                     "csmi_wm"     \
                     "csmi_bb"     \
                     "csmi_inv"    \
                     "csmi_diag"   \
